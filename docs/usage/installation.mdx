...
You can also [connect OpenHands to your local filesystem](/usage/runtimes/docker#connecting-to-your-filesystem),
run OpenHands in a scriptable [headless mode](/usage/how-to/headless-mode),
interact with it via a [friendly CLI](/usage/how-to/cli-mode),
or run it on tagged issues with [a GitHub action](/usage/how-to/github-action).
...
Are you having trouble? Check out our [Troubleshooting Guide](/usage/troubleshooting).
